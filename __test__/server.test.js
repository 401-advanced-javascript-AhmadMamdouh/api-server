...
describe('server', () => {
    ...
    it('3- should respond with 200 when getting from this dynamic route /categories/id', () => {
    ...
    it('6- should respond with 200 on editing on this dynamic route /categories/:id', () => {
    ...
    it('9- should respond with 200 on deleteing with this dynamic route /categories/:id', () => {
    ...
    it('12- should respond with 200 when getting from this dynamic route /products/id', () => {
    ...
    it('14- should respond with 200 on editing on this dynamic route /products/:id', () => {
        return mockRequest.put('/products/0').then((results) => {
            expect(results.status).toBe(200);
        });
    });
    it('15- should respond with 200 on partial editing on this dynamic route /products/:id', () => {
        return mockRequest.patch('/products/0').then((results) => {
            expect(results.status).toBe(200);
        });
    });
    it('16- should respond with 200 on deleteing with this dynamic route /products/:id', () => {
